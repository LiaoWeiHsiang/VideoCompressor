...
public final class TextFrameProvider: @unchecked Sendable {
    ...
    @MainActor
    public func update(timeline: EditorTimeline, renderSize: CGSize) {
    ...
    public func frame(for segmentID: UUID) -> SubtitleRenderFrame? {
...
public enum TextLayerComposer {
    nonisolated(unsafe) static public var frameProvider: TextFrameProvider?

    public static func evaluate(spec: TextLayerSpec, at compositionTime: CMTime) -> CIImage? {
