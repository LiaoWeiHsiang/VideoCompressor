...
/// Shared time ↔ pixel math (extracted to TimelineKitUISharedViews so macOS
/// and iOS render tracks with pixel-identical coordinates).
typealias TrackLayout = TimelineTrackLayout
