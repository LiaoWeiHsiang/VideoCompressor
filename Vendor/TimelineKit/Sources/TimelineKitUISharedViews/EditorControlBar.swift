...
public struct EditorControlBar: View {
    ...
    public init(store: EditorStore, onRequestFullScreenPreview: @escaping () -> Void = {}) {
        self.store = store
        self.onRequestFullScreenPreview = onRequestFullScreenPreview
    }
